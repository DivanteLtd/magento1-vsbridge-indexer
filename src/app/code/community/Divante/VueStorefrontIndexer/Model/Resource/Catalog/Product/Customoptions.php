...
/**
 * Class Divante_VueStorefrontIndexer_Model_Resource_Catalog_Product_Customoptions
 *
 * @package     Divante
 * @category    VueStoreFrontIndexer
 * @author      Niels Gongoll <ngongoll@highdigital.de
...
class Divante_VueStorefrontIndexer_Model_Resource_Catalog_Product_Customoptions
{
     ...
     * @return array
     */
    public function loadCustomOptions($storeId)
    {
